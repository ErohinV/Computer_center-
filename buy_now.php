...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_SESSION['username'])) {
        ...
        // Тут ви можете реалізувати логіку для покупки товару.
        // Наприклад, додати запис до таблиці замовлень, видалити товар з корзини і т.д.

        // Приклад видалення товару з корзини після покупки
